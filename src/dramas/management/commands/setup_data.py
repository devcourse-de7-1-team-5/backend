...
class Command(BaseCommand):
    help = '드라마, 회차 정보, 장르, 뉴스 데이터를 순서대로 크롤링하여 초기 데이터를 설정합니다.'
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            # 4. 장르 크롤링
            self.stdout.write(self.style.NOTICE("\n[2/3] 드라마 장르 크롤링을 시작합니다..."))
            call_command('crawler_genre')
            self.stdout.write(self.style.SUCCESS("[2/3] 드라마 장르 크롤링 완료!"))
